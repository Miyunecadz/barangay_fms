<div>
    <div class="page page-center">
        <div class="container-tight py-4">
          ...
          <form class="card rounded-3 card-md border-0 shadow position-relative" action=""  wire:submit.prevent="authenticateUser()" method="get" autocomplete="off">
            <div class="card-body">
                <div class="position-absolute top-0 start-50 translate-middle">
                    <div class="d-flex justify-content-center pt-4">
                        <div class=" bg-white py-2 px-2 rounded-circle border-top">
                ...
                <div class="mt-5">
                    ...
                    <div class="form-footer d-flex justify-content-center">
                        <button type="submit" class="btn btn-primary"  wire:loading.remove wire:target="authenticateUser">Sign in</button>

                        <button type="submit" class="btn btn-primary" wire:loading wire:target="authenticateUser" disabled>
